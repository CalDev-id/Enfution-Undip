...
<body>
  ...
  <div style="text-align: justify; font-size: 14px;">
    {{-- Kata sambutan --}}
    <div>
      <p><span style="font-style: italic; font-weight: 700;">Unfortunately,</span> <br> Your registration for the Coaching Session 2023 is not successfully processed. There can be several possible reasons why the registration is not successful.</p>
    </div>

    {{-- Info --}}
    <div>
        <p style="margin-bottom: 0;">For further information, please contact:</p> 
