...
<body>
  ...
  <div style="text-align: justify">
    {{-- Kata sambutan --}}
    <div>
      <p><span style="font-style: italic; font-weight: 700">Unfortunately,</span> <br> Your registration for the DBCC 2023 is not successfully processed. There can be several possible reasons why the registration is not successful.</p>
    </div>
