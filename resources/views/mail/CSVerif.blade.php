...
<body>
  ...
  <div style="text-align: justify; font-size: 14px">
    {{-- Kata sambutan --}}
    <div>
      <p><span style="font-style: italic; font-weight: 700;">Congratulations!</span> <br> You have successfully registered on Coaching Session DBCC 2023. <br> Your registration requirements are fulfilled and valid.</p>
    </div>

    {{-- Time for coaching session --}}
    <div style="margin-bottom: 20px">
      <p style="margin-bottom: 2px">Coaching Session will be held on</p>
      <table style="margin-left: 0" cellpadding="0" cellspacing="0">
        <tr style="text-align: left">
          <th>Date</th>
          <td style="display: inline-block; margin: 0 10px;">:</td>
          <td>Sunday, 20 August 2023</td>
        </tr>
         <tr style="text-align: left">
          <th>Platform</th>
          <td style="display: inline-block; margin: 0 10px;">:</td>
