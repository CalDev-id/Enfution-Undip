                        ...
                        <div>
                            <div className="md:mx-10 mb-5">
                                <p className="font-semibold mt-8">
                                    Are You a Participant of Diponegoro Business
                                    Case Competition?*
                                </p>
                                <div className="flex">
                                    <div className="flex my-2 self-center mr-5">
