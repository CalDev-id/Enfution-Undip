...
const DetailCC = ({ data_peserta, page, periode, status }) => {
    ...
    let no = 0;
    const prev_url = `/dashboard/coaching-clinic?periode=${periode}${
        page != null ? `&page=${page}` : ""
