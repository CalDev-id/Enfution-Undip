const TimeLine = () => {
    return (
        <>
            <h1 className="text-[#FFF9EE] text-center font-bold text-2xl">TIMELINE</h1>
                ...
                <div id="progress-bar-container">
                    <ul>
                        ...
                        <li className="step step04">
                            <div className="step-inner">November</div>
                        </li>
                        <li className="step step05">
                            <div className="step-inner">Desember</div>
                        </li>
                    </ul>
            ...
            <style jsx="true">
                {`
                    ...
                    #progress-bar-container li.active:before, #progress-bar-container li:hover:before {
                        ...
                        background: linear-gradient(to right, #EB9928 0%,#fff 100%); 
                    }
                    ...
                    #progress-bar-container #line-progress {
                        ...
                        height:100%;
                        background: #207893;	 
                        background: linear-gradient(to right, #EB9928 0%,#FFCE2E 100%); 
                        position:absolute;
                        z-index:2;
                        border-radius:50px;
                        transition:all ease 0.9s;
